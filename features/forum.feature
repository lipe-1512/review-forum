Feature: Forum management
  ...
  Scenario: Creating a forum
    ...
    When this user creates a new forum with the Title "O que vocês acharam do Sonic 3?", Description "I think went well, but should've done better this time" and Related Film "Sonic 3"
